...
def calculate_dosage(patient):
    ...
    if weight is None:
        print(f"Missing weight")
        return patient 
    if medication is None:
        print(f"Missing medication")
        return patient
    ...
    if is_first_dose is None:
        print(f"is_first_dose not exist")
        return patient
    loading_dose_applied = False
...
def main():
    ...
    for patient in patients_with_dosages:
        ...
        print(f"Name: {patient.get('name', 'Unknown')}, Medication: {patient['medication']}, "
